...
- **[Translations](translations.md)** - Contributing language translations
- **[Branding](branding.md)** - Brand identity and messaging guidelines
- **[Future Ideas](future-ideas.md)** - Planned features and roadmap
- **[Advanced Storage](advanced/)** - Design docs for the companion advanced-storage mod
